...
\section{Skills}
  \resumeSubHeadingListStart
    \item{
      ...
      \textbf{Systems}{: \directlua{printList("_data/personal.json", "databases", "database")}}
      }
  \resumeSubHeadingListEnd
...
\section{Research Area}
  \resumeSubHeadingListStart
	\directlua{printEduItems("_data/research.json")}
  \resumeSubHeadingListEnd

% Print Publications
%-------------------------------------------
\section{\href{https://github.com/pforpallav}{Publications}}
  \resumeSubHeadingListStart
    \directlua{printProjItems("_data/pub.json")}
  \resumeSubHeadingListEnd
...
\section{Achievement}
  \resumeSubHeadingListStart
	\directlua{printEduItems("_data/achieve.json")}
  \resumeSubHeadingListEnd
